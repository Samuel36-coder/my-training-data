...
| Secondary | [Running (5k, 10k, Half marathon, Marathon, Trail running)] |

### Goals

| Goal | Target Date |
|------|-------------|
| [Sub 40 min 10k run race] | [2026-2027] |
| [300W cycling FTP] | [2026] |
| [Marathon pace 4:55 min/km] | [2027] |

**Current Phase:** [Aerobic build + threshold development and VO2 max increasing]  
**Training Style:** [High-volume polarized (~15h/week) with 2/3 run/week, 2/3 bike ride/week, 2 gym day/week]
...
| Component | Details |
|-----------|---------|
| Bike trainer | [ThinkRider X2Max] |
| Road Bike | [trek domane sl5 2021] |
| Platform | [Garmin, Strava] |
| Sensors | [HRM, power meter, cadence, speed] |
| Pedals | [Favero Assioma PRO RL-1] |
...
|-----------|---------|
| Road Bike | [trek domane sl5 2021] |
| MTB | [focus thron 6.8 2020] |
| Platform | [Garmin, Strava] |
| Power Meter | [Favero Assioma PRO RL-1] |
| Sportwatch | [Garmin Forerunner 965] |
| Bike computer | [Garmin Eddge 530] |
| HRM | [garmin hrm dual] |
| Sensors | [HRM, power meter, cadence, speed] |
| Pedals | [Favero Assioma PRO RL-1] |
| Run shoes road | [Kiprun KD900.2] |
| Run shoes trail | [Kiprun MT CUSHION 2] |

### Other Modalities

| Modality | Equipment | Purpose |
|----------|-----------|---------|
| [Recovery] | [Roller foam] | [recovery post workout] |

### Environment

| Factor | Details |
|--------|---------|
| Indoor | [Road bike mounted on the direct drive trainer over a rubber mat, no ventilation and temperature 20-25C] |
| Outdoor | [Mostly road, with weather conditions in Vienna, Austria] |
...
**Baseline:** [10] hours/week (± [5] hours)  
...
|-----|-----------------|----------|-----------|
| Sunday | [Long bike ride] | [100-150 km, +1000-2000m elevation] | [Especilly during spring/summer and mostly Z2 effort] |
| Monday | [Strenght] | [60 min] | [chest, shoulders, quads, calfes + I can add optionally 30 min Z2 ride to support recovery] |
| Tuesday | [Intervals] | [10-15 km] | [Focus on improving speed and VO2 max] |
| Wednesday | [Z2 bike ride] | [60-120 min] | [Keep it easy with high cadence] |
| Thursday | [Threshold/Tempo] | [10-15km ] | [Focus on improving Lactate threshold or tempo durability] |
| Friday | [Strenght] | [60 min] | [back, arms, glutes, hamstring + I can add optionally 30 min Z2 ride to support recovery] |
| Saturday | [Long run] | [60-120 min] | [Long easy run with HR < 150 bpm to improve endurance>] |
...
**Current FTP:** [256 W] (Indoor: [256 W])  
**Max HR:** [197 bpm]  
**Threshold HR:** [177 bpm]
...
|--------|-------|-------|
| FTP (Outdoor) | [256 W] | |
| FTP (Indoor) | [256 W] | Adjusted for indoor conditions |
| LT2 HR | [177 bpm] | ||
| Weekly Volume | [15 hours] | 

### Weight Tracking

**Protocol:** [Every morning, Empty stomach]  
...
**URL:** `https://raw.githubusercontent.com/Samuel36-coder/my-training-data/main/latest.json`

**Archive:** `https://github.com/Samuel36-coder/my-training-data/tree/main/archive`

**— OR (GitHub connector) —**

**Repo:** `Samuel36-coder/my-training-data` (connected via platform's GitHub integration — AI reads files directly, no URLs needed)
